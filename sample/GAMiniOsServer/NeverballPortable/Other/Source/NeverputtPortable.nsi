...
!define PORTABLEAPPNAME "Neverputt Portable"
!define APPNAME "Neverputt"
!define NAME "NeverputtPortable"
!define OTHERNAME "NeverballPortable"
!define VER "1.5.6.0"
!define WEBSITE "PortableApps.com/NeverballPortable"
!define DEFAULTEXE "neverputt.exe"
!define OTHEREXE "neverball.exe"
!define DEFAULTAPPDIR "Neverball"
...
Section "Main"
	...
	DisplaySplash:
		StrCmp $DISABLESPLASHSCREEN "true" GetPassedParameters
			...
			InitPluginsDir
			File /oname=$PLUGINSDIR\splash.jpg "${OTHERNAME}.jpg"
			newadvsplash::show /NOUNLOAD /PASSIVE 1200 0 0 -1 /L $PLUGINSDIR\splash.jpg
